...
image:https://ci.jenkins.io/buildStatus/icon?job=Plugins%2Femoji-symbols-api-plugin%2Fmain[link="https://ci.jenkins.io/job/Plugins/job/emoji-symbols-api-plugin/job/main/"]
